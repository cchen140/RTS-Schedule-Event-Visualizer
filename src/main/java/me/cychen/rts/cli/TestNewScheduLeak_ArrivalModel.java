 ...
 */
public class TestNewScheduLeak_ArrivalModel {
    ...
    private static final Logger loggerExp_by_arrivalMode = LogManager.getLogger("exp_by_arrivalModel");
    ...
    public static void main(String[] args) {
        ...
        loggerExp_by_arrivalMode.trace("#averagePrecisionBySimTime");

        //for (int simTimeByLcmPoPv=1; simTimeByLcmPoPv<=20; simTimeByLcmPoPv++) {
        for (double desiredPrecision=0.1; desiredPrecision<1.0; desiredPrecision+=0.1)
        {
                ...
                for (int numOfTasks = 5; numOfTasks <= 15; numOfTasks += 2) {
                    ...
                    for (double util = 0.001; util < 1; util += 0.1) {
                        ...
                        /* Optimal attack condition experiment. */
                            ...
                            singleNewScheduLeakTest.desiredConfidentLevel = desiredPrecision;
                            ...
                            long predictedTimeToSuccess = singleNewScheduLeakTest.scheduLeak.computeLcmPoPvTimesByConfidenceLevel(desiredPrecision);
            ...
            double averageSuccessRate = cumulativeSuccessCountBySimTime/(6.0*1.0);
            double averagePrecisionBySimTime = cumulativePrecisionBySimTime/(6.0*1.0);
            ...
            //loggerExp_by_arrivalMode.trace("#averagePrecisionBySimTime");
            loggerExp_by_arrivalMode.trace("\r\n");
            loggerExp_by_arrivalMode.trace("{}\t", averagePrecisionBySimTime);
            loggerExp_by_arrivalMode.trace("{}\t", desiredPrecision);
        }
