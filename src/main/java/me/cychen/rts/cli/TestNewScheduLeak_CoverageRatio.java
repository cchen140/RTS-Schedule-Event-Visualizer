...
/**
 * Created by cy on 5/19/2017.
 */
public class TestNewScheduLeak_CoverageRatio {
    ...
    public static void main(String[] args) {
        ...
        for (double coverageRatio = 0.001; coverageRatio < 1; coverageRatio += 0.1) {
            double cumulativeConfidenceLevel = 0;
            double cumulativeSuccessCountBySimTime = 0;
            double cumulativePrecisionBySimTime = 0;
            for (int victimPriorityMode = 1; victimPriorityMode <= 3; victimPriorityMode+=2) {
                //{
...
//                            taskSetGenerator.setMinObservationRatio(1);
                            taskSetGenerator.setMaxObservationRatio(coverageRatio + 0.1);
                            taskSetGenerator.setMinObservationRatio(coverageRatio);
            ...
            double averageConfidenceLevel = cumulativeConfidenceLevel/(NUM_OF_TEST_PER_CONDITION*10.0*6.0*2.0);
            double averageSuccessRate = cumulativeSuccessCountBySimTime/(6.0*2.0);
            double averagePrecisionBySimTime = cumulativePrecisionBySimTime/(6.0*2.0);
